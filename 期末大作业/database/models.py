...
class BilibiliVideo(Base):
    ...
    source_keyword = Column(Text, nullable=True)
...
class XhsNote(Base):
    ...
    # 情感分析字段
    sentiment_score = Column(Text)  # 情感得分: -1.0 �?1.0
    sentiment_label = Column(String(20))  # 情感标签: positive/negative/neutral
    sentiment_confidence = Column(Text)  # 置信�? 0.0 �?1.0
    analyzed_at = Column(BigInteger)  # 分析时间�?
...
class XhsNoteComment(Base):
    ...
    source_keyword = Column(Text, nullable=True)  # 来源关键�?
    # 情感分析字段
    sentiment_score = Column(Text)  # 情感得分: -1.0 �?1.0
    sentiment_label = Column(String(20))  # 情感标签: positive/negative/neutral
    sentiment_confidence = Column(Text)  # 置信�? 0.0 �?1.0
